...
class ItemDtoJsonTest {
    ...
    void serialize_WithAllFields_FormatsCorrectly() throws Exception {
        ...
        assertThat(jsonContent).contains("\"description\":\"A powerful laptop\"");
        assertThat(jsonContent).contains("\"available\":true");
        assertThat(jsonContent).contains("\"owner\":100");
        assertThat(jsonContent).contains("\"request\":5");
        ...
        assertThat(jsonContent).contains("\"bookerId\":20");
    }

    @Test
    void deserialize_WithAllFields_ParsesCorrectly() throws Exception {
        String jsonContent = "{" + "\"id\":1," + "\"name\":\"Laptop\"," + "\"description\":\"A powerful laptop\"," + "\"available\":true," + "\"owner\":100," + "\"request\":null," + "\"lastBooking\":null," + "\"nextBooking\":null," + "\"comments\":[]" + "}";
